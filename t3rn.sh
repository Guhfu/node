...
case $choice in
    1)
        ...
        echo "EXECUTOR_PROCESS_ORDERS_ENABLED=true" >> $CONFIG_FILE
        echo "EXECUTOR_PROCESS_CLAIMS_ENABLED=true" >> $CONFIG_FILE
        echo "EXECUTOR_PROCESS_PENDING_ORDERS_FROM_API=false" >> $CONFIG_FILE
        echo "EXECUTOR_PROCESS_ORDERS_API_ENABLED=false" >> $CONFIG_FILE
        echo "EXECUTOR_ENABLE_BATCH_BIDING=true" >> $CONFIG_FILE
